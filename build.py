...
APPLE_DEVELOPER_ID_EMAIL = "apple@nicholasrbarrow.com" # fill this in
APP_SPECIFIC_PASSWORD = "pcfp-qmlj-zsnw-orbf" # fill this in
...
app.setup(script="./example/src/main.py")
# build your app
app.build()
...
# build your package
package.build(hash=get_first_installer_hash(), postinstall_script="./src/Scripts/postinstall")
# sign your package
